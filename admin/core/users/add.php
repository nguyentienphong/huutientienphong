...
$myform->removeHTML(0);
$myform->add('use_type','use_type',1,0,0,0,'Bạn chưa nhập chọn loại tài khoản');
      ...
      <div class="col-sm-12">
         <section class="panel">
            ...
            <div class="panel-body">
               ...
               <?=$form->textnote('Các trường có dấu (<span class="form-asterick">*</span>) là bắt buộc nhập')?>
               <?=$form->select(array('label'=>'Loại tài khoản','name'=>'use_type', 'id'=>'use_type','option'=>$arr_use_type, 'title'=>'Chọn loại tài khoản','require'=>1,'errorMsg'=>'Bạn chưa chọn loại tài khoản','selected'=>getValue('use_type','int','POST',1),'class'=>'col-sm-9'))?>
               <?=$form->text(array('label'=>'Email','name'=>'use_email','id'=>'use_email','value'=>getValue('use_email','str','POST',$use_email),'require'=>1, 'errorMsg'=>'Bạn chưa nhập email', 'placeholder'=> 'Email không dài quá 255 ký tự','class'=>'col-sm-9'))?>
               <?=$form->password(array('label'=>'Mật khẩu','name'=>'use_password','id'=>'use_password','require'=>1,'errorMsg'=>'Bạn chưa nhập mật khẩu','class'=>'col-sm-9'))?>
               <?//=$form->text(array('label'=>'Họ','name'=>'use_firstname','id'=>'use_firstname','value'=>getValue('use_firstname','str','POST',$use_firstname),'require'=>1, 'errorMsg'=>'Bạn chưa nhập họ', 'placeholder'=> 'Họ','class'=>'col-sm-9'))?>
               <?//=$form->text(array('label'=>'Tên','name'=>'use_lastname','id'=>'use_lastname','value'=>getValue('use_lastname','str','POST',$use_lastname),'require'=>1, 'errorMsg'=>'Bạn chưa nhập tên', 'placeholder'=> 'Tên','class'=>'col-sm-9'))?>
               ...
               <?//=$form->text(array('label'=>'Điện thoại','name'=>'use_phone','id'=>'use_phone','value'=>getValue('use_phone','str','POST',''),'require'=>1, 'errorMsg'=>'Bạn chưa nhập điện thoại', 'placeholder'=> 'Điện thoại','class'=>'col-sm-9'))?>
               <?//=$form->text(array('label'=>'Địa chỉ','name'=>'use_contact','id'=>'use_contact','value'=>getValue('use_contact','str','POST',''),'require'=>1, 'errorMsg'=>'Bạn chưa nhập địa chỉ', 'placeholder'=> 'Địa chỉ','class'=>'col-sm-9'))?>
