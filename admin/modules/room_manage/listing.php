...
$list->add('','Tên phòng','string',1,1, 'width="120px"');
$list->add('','Giá phòng','string');
$list->add('','Sửa','edit');
      ...
      <div class="col-sm-12">
         <section class="panel">
            ...
            <div class="panel-body">
               ...
               <td width='350'>
                  <a class="llink" href="edit.php?record_id=<?=$row[$id_field]?>"><?=$row['roo_name']?></a>
               </td>
               <td>
                  <div class="lrow"><?=number_format($row['roo_price'])?></div>
               </td>
