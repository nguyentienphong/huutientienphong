      ...
      <div class="col-sm-12">
         <section class="panel">
            ...
            <div class="panel-body">
               ...
               <td>
                  <div class="lrow"><?=date('d/m/Y - H:ia',$row['pos_date'])?></div>
               </td>
               <td>
                  <div class="lrow"><?=$row['pos_tags']?></div>
               </td>
               <td>
                  <div class="lrow">
               ...
               <?//=$list->showCheckbox('pos_hot',$row['pos_hot'],$row[$id_field])?>
               <?=$list->showCheckbox('pos_active',$row['pos_active'],$row[$id_field])?>
