      ...
      <div class="col-sm-12">
         <section class="panel">
            ...
            <div class="panel-body">
               ...
               <td>
                  <div class="lrow"><?=date('d/m/Y - H:ia',$row['met_date'])?></div>
               </td>
               <td>
                  <div class="lrow"><?=$row['met_tags']?></div>
               </td>
               <td>
                  <div class="lrow">
               ...
               <?=$list->showCheckbox('met_hot',$row['met_hot'],$row[$id_field])?>
               <?=$list->showCheckbox('met_active',$row['met_active'],$row[$id_field])?>
