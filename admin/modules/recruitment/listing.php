      ...
      <div class="col-sm-12">
         <section class="panel">
            ...
            <div class="panel-body">
               ...
               <td>
                  <div class="lrow"><?=date('d/m/Y - H:ia',$row['rec_date'])?></div>
               </td>
               <td>
                  <div class="lrow">
               ...
               <?//=$list->showCheckbox('rec_hot',$row['rec_hot'],$row[$id_field])?>
               <?=$list->showCheckbox('rec_active',$row['rec_active'],$row[$id_field])?>
