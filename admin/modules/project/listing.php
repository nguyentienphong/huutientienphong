...
$list_cat = array(''=>'Không có danh mục');
      ...
      <div class="col-sm-12">
         <section class="panel">
            ...
            <div class="panel-body">
               ...
               <td>
                  <div class="lrow"><?=date('d/m/Y - H:ia',$row['prj_date'])?></div>
               </td>
               <td>
                  <div class="lrow">
               ...
               <?//=$list->showCheckbox('prj_hot',$row['prj_hot'],$row[$id_field])?>
               <?=$list->showCheckbox('prj_active',$row['prj_active'],$row[$id_field])?>
