      ...
      <div class="col-sm-12">
         <section class="panel">
            ...
            <div class="panel-body">
               ...
               <td>
                  <div class="lrow"><?=date('d/m/Y - H:ia',$row['cul_date'])?></div>
               </td>
               <td>
                  <div class="lrow">
               ...
               <?=$list->showCheckbox('cul_hot',$row['cul_hot'],$row[$id_field])?>
               <?=$list->showCheckbox('cul_active',$row['cul_active'],$row[$id_field])?>
