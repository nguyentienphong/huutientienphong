      ...
      <div class="col-sm-12">
         <section class="panel">
            ...
            <div class="panel-body">
               ...
               <td>
                  <div class="lrow"><?=$row['mng_position']?></div>
               </td>
               <td>
                  <div class="lrow">
               ...
               <?//=$list->showCheckbox('mng_hot',$row['mng_hot'],$row[$id_field])?>
               <?//=$list->showCheckbox('mng_active',$row['mng_active'],$row[$id_field])?>
