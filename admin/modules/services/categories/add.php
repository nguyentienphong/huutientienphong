...
$myform->add('cat_description_en','cat_description_en',0,0,'');
$myform->add('cat_type','cat_type',0,1,'',1,'Bạn chưa chọn loại danh mục');
      ...
      <div class="col-sm-12">
         <section class="panel">
            ...
            <div class="panel-body">
               ...
               <?=$form->tinyMCE('Mô tả danh mục tiếng anh', 
                              'cat_description_en', 
                              'cat_description_en', 
                              getValue('cat_description_en','str','POST',''), 
                              '100%'
               )?>
