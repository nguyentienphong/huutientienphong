...
//$myform->add('ser_detail_ko','ser_detail_ko',0,0,'',0,'Bạn chưa nhập chi tiết tiếng hàn');
         ...
         <section class="panel">
            ...
            <div class="panel-body">
               <?print_error_msg($bg_errorMsg)?>
                ...
                <?=$form->text(array('label'=>'Tên tiếng hàn','name'=>'ser_title_ko','id'=>'ser_title_ko','value'=>getValue('ser_title_ko','str','POST',''),'require'=>0, 'errorMsg'=>'Bạn chưa nhập tên tiếng hàn', 'placeholder'=> 'Tên không dài quá 255 ký tự','class'=>'col-sm-9'))?>
                <script>
               ...
               <?=$form->textarea(array('label'=> 'Tóm tắt tiếng hàn', 'name'=> 'ser_summary_ko', 'id'=> 'ser_summary_ko','value'=>getValue('ser_summary_ko','str','POST',''),'errorMsg'=>'Bạn chưa nhập tóm tắt tiếng hàn', 'style'=>'width:100%;height:100px', 'require'=> 0,'class'=>'col-sm-9'))?>
