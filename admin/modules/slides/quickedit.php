...
if($iQuick == 'update'){
	...
	if($total_record > 0){
		for($i = 0; $i < $total_record; $i++){
			...
			//Insert to database
            $myform->add('sli_title', "sli_title" . $record_id[$i], 0, 0, '', 0, '', 0, '');
            $myform->add('sli_cat_id', "sli_cat_id" . $record_id[$i], 1, 0, '', 0, '', 0, '');
            $myform->add('sli_position', "sli_position" . $record_id[$i], 1, 0, 0, 0, '', 0, '');
			//Add table
