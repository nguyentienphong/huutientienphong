...
$list = new dataGrid('off_id',30);
$list->add($name_field,'Tên văn phòng','string',1,1, 'width="120px"');
...
$db_count = new db_count('SELECT count(*) as count 
                            FROM '.$bg_table.'
                            WHERE 1 AND off_id != 1 '.$list->sqlSearch().' '.$list->authorSearch($bg_table,$id_field).'
                            ');
      ...
      <div class="col-sm-12">
         <section class="panel">
            ...
            <div class="panel-body">
               ...
               <?//=$list->showCheckbox('off_hot',$row['off_hot'],$row[$id_field])?>
               <?//=$list->showCheckbox('off_active',$row['off_active'],$row[$id_field])?>
