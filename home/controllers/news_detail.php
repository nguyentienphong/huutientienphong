				...
				<div class="row">
					<div class="col-md-7 col-md-push-5">
						<article class="animate-box">
							<div class="blog-img" style="background-image: url(<?=$post_detail['pos_image']?>);"></div>
							<div class="desc">
								<div class="meta">
									<p>
										<span><?=getDateTime(($lang_id+1),0,1,1,'',$post_detail['pos_date'])?> </span>
										<span>admin </span>
									</p>
								</div>
								<h2><a href="/tin-tuc/<?=$post_detail['pos_alias']?>.html"><?=$post_detail['pos_title']?></a></h2>
								<p><?=$post_detail['pos_detail']?></p>
							</div>
						</article>
